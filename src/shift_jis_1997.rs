...
/// JIS` (Shift Japanese Industrial Standards) version `1997`.
///
/// There are multiple versions of [Shift JIS][`ShiftJis1997`], but this module
/// only supports the version known as [Shift JIS 1997][`ShiftJis1997`].
///
/// [Shift JIS][`ShiftJis1997`] is an encoding for Japanese characters and is an
/// extension to the [JIS X 0201][`crate::encoding::JisX0201`] encoding. The
/// first 128 characters and the half-width katakana section of [Shift
/// JIS][`ShiftJis1997`] are identical to [JIS X
/// 0201][`crate::encoding::JisX0201`]. The remaining unused characters in [JIS
/// X 0201][`crate::encoding::JisX0201`] are taken advantage of to encode more
