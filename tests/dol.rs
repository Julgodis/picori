...
mod dol_tests {
    ...
    // 0x00000100, 0x00002620, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    // 0x00000000, ];
    // let text_address: [u32; 7] = [
    // 0x80003100, 0x800056e0, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    // 0x00000000, ];
    // let text_size: [u32; 7] = [
    // 0x00002520, 0x00332fa0, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    // 0x00000000, ];
    // let data_offset: [u32; 11] = [
    // 0x003355c0, 0x00335620, 0x00335680, 0x00335820, 0x00335840, 0x0036e580,
    // 0x0039f960, 0x003a00a0, 0x00000000, 0x00000000, 0x00000000,
    // ];
    // let data_address: [u32; 11] = [
    // 0x80005620, 0x80005680, 0x80338680, 0x80338820, 0x80338840, 0x80371580,
    // 0x803f60e0, 0x803f7d00, 0x00000000, 0x00000000, 0x00000000,
    // ];
    // let data_size: [u32; 11] = [
    // 0x00000060, 0x00000060, 0x000001a0, 0x00000020, 0x00038d40, 0x000313e0,
    // 0x00000740, 0x00005220, 0x00000000, 0x00000000, 0x00000000,
    // ];
    //
